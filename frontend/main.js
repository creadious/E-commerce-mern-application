...
const showProductList = () => {
    const productData = [
        {
            imageUrl: 'https://www.biba.in/dw/image/v2/BKQK_PRD/on/demandware.static/-/Sites-biba-product-catalog/default/dw68719691/images/ss24/ribayat2344ss24skblu_1.jpg',
            title: 'SKY BLUE VISCOSE TIERED DRESS',
            description: 'Flowy Sky Blue Tiered Dress With A Multicolor Floral Print, Perfect For A Breezy, Stylish Day.',
            price: 1500,
            originalPrice: 2500,
            stockLeft: 10
        },
